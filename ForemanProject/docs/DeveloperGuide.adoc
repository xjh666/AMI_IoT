...
* OnClickListener is set for the name of the host in the configuration status table., which sets the properies of the host and opens link:{repoURL}/ForemanProject/app/src/main/java/com/example/foremanproject/activity/HostDetail.java[`HostDetail`] activity.
