...
** If `EDIT` is clciked, `"GET /api/hostgroups/:id "` is used repeatedly to get the hierachy of the host group, which will be used to detect inherited value of parameters
